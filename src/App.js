...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0xF09e88B8F82d07E65eA5d8e3599113502624164d";
const POINTS_EXCHANGE_ADDRESS = "0x6e778E7e88ee9B32ec7be93Dcc563e7875eF3D30";
      ...
      {!isWalletConnected ? (
        ...
        <main className="main-content">
          <section className="account-info">
            {account && <p>连接账号: <span className="highlight">{account}</span></p>}
          </section>
          ...
          <section className="import-section">
            ...
            <div className="input-group">
              ...
              />
              <button className="btn-primary" onClick={handleLoadContract}>
                导入合约
              </button>
            </div>
          </section>
          ...
          <section className="issue-section">
            ...
            <div className="input-group">
              <input
                ...
                placeholder="Amount"
              />
              <button className="btn-primary" onClick={issueRegularPoints}>
                发行积分
              </button>
            </div>
          </section>
          ...
          <section className="balance-section">
            <h2>积分余额</h2>
            <p>通用积分余额: <span className="highlight">{universalPointsBalance}</span> UPT</p>
            <p>普通积分余额: <span className="highlight">{userPointsBalance}</span> {symbol || 'RLP'}</p>
            <button className="btn-secondary" onClick={getPointsBalance}>
              更新余额
            </button>
          </section>
          ...
          <section className="exchange-section">
            ...
            <button className="btn-primary" onClick={exchangePoints}>
              兑换
            </button>
          </section>
        </main>
